...
## 2026-04-25 — Webapp-Only Repository Direction
...
- Browser playtest of the full preview path.
- Parser fairness pass.
- Wrong-command response variety.
- Audio listening pass from title to preview ending.
- `flutter test` and `flutter build web` before publication.
